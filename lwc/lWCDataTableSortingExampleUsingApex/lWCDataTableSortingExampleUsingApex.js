...
import getContacts from '@salesforce/apex/LWCDataTableSortingExampleUsingApex.getContacts';
...
export default class LWCDataTableSortingExampleUsingApex extends LightningElement {
    @track data;
